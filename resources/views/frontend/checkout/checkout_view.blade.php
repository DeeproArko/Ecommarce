            ...
            <div class="row">
                ...
                <form method="post" action="{{ route('checkout.store') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-4">
                            <input required="" type="text" Placeholder="Phone Number" name="shipping_phone"
                    ...
                    <div class="form-group mb-30">
                        <textarea rows="5" required="" placeholder="Shipping Address" name="shipping_address">{{ Auth::user()->address }}</textarea>
                    </div>
