...
<head>
    ...
    <meta name="google-site-verification" content="DCLR-e1Hnw9Z8QPKiXJvMD3cd1exK5ttytXScqST0xs" />
    <!--<meta name="google-site-verification" content="yts45wYi93wilnoWN6P9dWCKO0IhxdcDNyPWK39exqs" />-->
    <!-- Favicon -->
    ...
    <script>
      ...
      chatbox.setAttribute("page_id", "555613628269711");
...
.detail-extralink .detail-qty {
    ...
    border: 2px solid #ffca44 !important;
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-1YRW0EQ7QS"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-1YRW0EQ7QS');
</script>
