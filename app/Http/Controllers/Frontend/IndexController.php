...
class IndexController extends Controller
{
    ...
    {
        return view('frontend.featuredProducts.campaign_products');
    } // End Method
    ...
    public function CatWiseProduct(Request $request, $id, $slug)
    {
        ...
        return view('frontend.product.category_view', compact('products', 'subcategories', 'breadcat', 'newProduct'));
    } // End Method
    ...
    public function SubCatWiseProduct(Request $request, $id, $slug)
    {
        $products = Product::where('status', 1)
            ...
            ->orderBy('id', 'DESC')
            ->get();
        $category = SubCategory::select('category_id')->where('id',$id)->first();
        ...
        return view('frontend.product.subcategory_view', compact('products', 'subCategories', 'breadsubcat', 'newProduct'));
    } // End Method
